...
/**
 * Multi-curl slots trait for miniAPIclient (optional, not use by default)
 *
 * If you really need async-mode, you can include this trait in one step:
 * - Uncomment string "use miniAPIslots" in miniAPIclient.php
 *
 *
 * PHP Version >= 5.5
 *
 * @package    ierusalim/miniAPI
